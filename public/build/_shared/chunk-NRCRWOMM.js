...
var WaterSplash = () => {
  _s();
  const group = (0, import_react.useRef)();
    ...
    const generateFlowers = () => {
      ...
      const animateFlowers = () => {
        flowers.children.forEach((flower) => {
          ...
          flower.position.y = Math.sin(flower.rotation.x) * 2;
        });
      };
      const animate = () => {
...
_s(WaterSplash, "Y5oCzaHjnbza+vDScUUGc6hhnQQ=");
_c = WaterSplash;
var WaterSplash_default = WaterSplash;
var _c;
$RefreshReg$(_c, "WaterSplash");
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1707059441684.9038";
}
function Headers2() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(HeaderBackground_default, {}, void 0, false, {
