...
const MilestoneContainer = () => {
    return (
        <div className="p-10">
            <div className="p-4">
                <a href="#" className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row hover:bg-gray-100 dark:border-amber-500 dark:bg-amber-200 dark:hover:bg-amber-300">
