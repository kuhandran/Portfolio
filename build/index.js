...
var personal_default, init_personal = __esm({
  "app/images/personal.png"() {
    personal_default = "/build/_assets/personal-4WCQVKHW.png";
  }
});
...
var HeaderNavigation = () => /* @__PURE__ */ jsxDEV5("nav", { className: "sticky top-0 z-50 w-full bg-amber-100 border-b border-amber-100", children: /* @__PURE__ */ jsxDEV5("div", { className: "flex flex-row justify-between px-3 py-4 sm:px-8 xl:px-12 lg:py-5", children: [
