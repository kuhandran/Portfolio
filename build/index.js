...
var downloadPdf, HeaderPage, HeaderPage_default, init_HeaderPage = __esm({
  "app/components/HeaderPage/HeaderPage.jsx"() {
    ...
    downloadPdf = () => {
      let pdfUrl = "";
      window.location.hostname == "localhost" ? pdfUrl = "http://" + window.location.hostname + ":" + window.location.port + "/resources/resume.pdf" : pdfUrl = "http://" + window.location.hostname + "/resources/resume.pdf", console.log(pdfUrl, "pdfUrl"), window.open(pdfUrl);
